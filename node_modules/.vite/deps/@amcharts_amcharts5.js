import {
  ...
  supports,
  trim
} from "./chunk-QT3KL2BL.js";
import "./chunk-GHANC6LZ.js";
import {
  ArrayDisposer,
  Array_exports,
  CounterDisposer,
    ...
    for (let i = 0, len = info.parts.length; i < len; i++) {
      ...
      switch (info.parts[i]) {
        ...
        case "nnn":
          ...
          break;
        case "z":
          value = getTimeZone(date, false, false, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0).replace(/[+-]+[0-9]+$/, "");
          break;
        case "zz":
          value = getTimeZone(date, true, false, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0);
          break;
        case "zzz":
          value = getTimeZone(date, false, true, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0).replace(/[+-]+[0-9]+$/, "");
          break;
        case "zzzz":
          value = getTimeZone(date, true, true, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0);
          break;
        case "Z":
        case "ZZ":
...
var LineStyle = class extends Op {
  constructor(width, color2, lineJoin) {
    super();
...
var CanvasGraphics = class extends CanvasDisplayObject {
  ...
  lineStyle(width = 0, color2, alpha = 1, lineJoin) {
...
var Root = class _Root {
  ...
  _renderFrame(currentTime) {
    if (this._updateTick) {
      ...
      return this._tickers.length === 0 && animationDone && !this._isDirty;
    } else {
      return true;
    }
  }
        ...
        if (points) {
          ...
          if (cl > pl) {
            ...
            for (let i = 0; i < pl; i++) {
              ...
              newCopy[i] = { x: copy3[index].x, y: copy3[index].y };
            }
            copy3 = newCopy;
          }
...
var ZoomableContainer = class extends Container {
  ...
  _animateTo(x, y, scale) {
    ...
    const contents = this.contents;
    this._txa = contents.animate({ key: "x", to: x, duration, easing });
    this._tya = contents.animate({ key: "y", to: y, duration, easing });
    this._za = contents.animate({ key: "scale", to: scale, duration, easing });
  }
