...
function spiralPoints(cx, cy, radius, radiusY, innerRadius, step, radiusStep, startAngle, endAngle) {
  ...
  while (r < radius + radiusStep) {
    ...
    let point5 = { x: cx + r * Math.cos(angle), y: cy + r * radiusY / radius * Math.sin(angle) };
    points.push(point5);
    ...
    if (this.isDirty("textAlign") || this.isDirty("width")) {
      ...
      if (this.get("width") != null) {
        ...
        if (textAlign == "left" || textAlign == "start") {
          x2 = this.get("paddingLeft");
        } else if (textAlign == "right" || textAlign == "end") {
          x2 = -this.get("paddingRight");
        }
      }
      this.text.set("x", x2);
    }
...
//# sourceMappingURL=chunk-QT3KL2BL.js.map
